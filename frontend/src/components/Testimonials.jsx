      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#0A1628] mb-4">
            Client <span className="bg-gradient-to-r from-[#D4AF37] to-[#F4C430] bg-clip-text text-transparent">Testimonials</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-white rounded-3xl shadow-2xl p-12 border-2 border-[#D4AF37]/20">
            ...
            <div className="absolute -top-6 left-12">
              <div className="w-12 h-12 bg-gradient-to-br from-[#D4AF37] to-[#F4C430] rounded-full flex items-center justify-center shadow-lg">
