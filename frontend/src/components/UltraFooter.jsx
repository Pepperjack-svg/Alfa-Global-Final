          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col items-center sm:items-end gap-2">
              ...
              >
                ...
                <span className={`font-semibold ${theme === 'gold' ? 'text-amber-500' : theme === 'silver' ? 'text-gray-400' : theme === 'purple' ? 'text-purple-400' : 'text-teal-400'}`}>Techbook Technologies</span>
